          ...
          <div className='grid grid-cols-2 md:grid-cols-3 gap-10 items-start mt-10 md:mt-0 w-full md:w-auto'>
            ...
            <div className='flex flex-col space-y-4'>
              ...
              <div className='flex gap-4 items-center'>
                ...
                <Link
                  href="https://reddit.com/r/nexora"
                  target="_blank"
                ...
                <Link
                  href="https://status.nexora.com"
                  target="_blank"
                  className="text-xs font-medium text-neutral-500 hover:text-blue-500 transition ml-2 border border-neutral-200 dark:border-neutral-800 rounded-full px-3 py-1"
                >
                  System Status
                </Link>
              </div>
