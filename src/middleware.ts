...
const SECURITY_HEADERS: Record<string, string> = {
  ...
  'Content-Security-Policy': [
    ...
    "img-src 'self' data: blob: https://images.unsplash.com https://www.every-ai.com https://assets.aceternity.com https://github.com https://avatars.githubusercontent.com https://api.iconify.design https://assets.puter.site",
    "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://*.upstash.io https://o4509996976242688.ingest.de.sentry.io https://challenges.cloudflare.com https://static.cloudflareinsights.com https://cloudflareinsights.com https://api.iconify.design https://formsubmit.co https://puter.com https://*.puter.com",
    "font-src 'self'",
    "frame-src 'self' https://challenges.cloudflare.com https://puter.com https://*.puter.com",
  ].join('; '),
}
